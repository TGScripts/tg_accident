...
Citizen.CreateThread(function()
    ...
    local resourceName = "Accident Script (" .. GetCurrentResourceName() .. ")"
    local scriptName = "tg_accident"
    ...
    function printVersionInfo(status, curVersion, newVersion)
        print('^4.-------------------------------------------------------------------------------------------------------------------.')
        print('^4|^0                                             TG Accident Script                                                    ^4|')
        print('^4|^0                                    <Made by Tiger (Discord: lets_tiger)>                                          ^4|')
        print('^4|-------------------------------------------------------------------------------------------------------------------|')

        if status == "veraltet" then
            print("^4|▶ ^0[^1ERROR^0] ^1" .. resourceName .. " ist veraltet! Bitte updaten: https://github.com/TGScripts/tg_accident        ^4|")
